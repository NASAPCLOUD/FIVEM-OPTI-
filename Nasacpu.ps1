...
$RecHeader.ForeColor = [System.Drawing.Color]::FromArgb(255, 255, 255) # Pure White
...
$RecBox.ForeColor = [System.Drawing.Color]::FromArgb(255, 255, 255) # Pure White Recommendation Checklist
...
$MainPanel.BackColor = [System.Drawing.Color]::FromArgb(0, 0, 0) # Pure Black
...
$MainHeader.ForeColor = [System.Drawing.Color]::FromArgb(255, 255, 255) # Pure White Title
...
function Create-CustomButton ($Text, $Top, $AccentColor, $Action) {
    ...
    $Btn.BackColor = [System.Drawing.Color]::FromArgb(15, 15, 15) # Very subtle dark tile background
    $Btn.ForeColor = [System.Drawing.Color]::FromArgb(255, 255, 255) # Pure White text inside button
    $Btn.FlatStyle = "Flat"
    $Btn.FlatAppearance.BorderSize = 1
    $Btn.FlatAppearance.BorderColor = [System.Drawing.Color]::FromArgb(40, 40, 40) # Sharp dark borders
    ...
    $Strip.BackColor = $AccentColor # Keeps the micro colored left border tag for clean visualization
...
# --- BUILD BUTTON LAYOUT (WITH DISTINCT HIGH-CONTRAST LEFT STRIPS) ---
